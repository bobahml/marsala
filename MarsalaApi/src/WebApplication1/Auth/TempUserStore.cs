...
{
    public class TempUserStore : IUserStore<ApplicationUser>,
                                     ...
                                     IUserTwoFactorStore<ApplicationUser>
    {
        ...
        public TempUserStore(IPasswordHasher<ApplicationUser> passwordHasher)
        {
            var user = new ApplicationUser { Email = "ADMIN@MAIL.RU", UserName = "ADMIN@MAIL.RU",  UserId="ABD99F3E-9408-4DC9-86AE-AD5EB27BFDAB" };
            user.PasswordHash = passwordHasher.HashPassword(user, "!!!q2w3E");

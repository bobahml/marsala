...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __Location_48:import30.Location;
  __UrlSerializer_49:import31.DefaultUrlSerializer;
  __RouterOutletMap_50:import32.RouterOutletMap;
  __NgModuleFactoryLoader_51:import33.SystemJsNgModuleLoader;
  __Router_52:any;
  __ActivatedRoute_53:any;
  _NoPreloading_54:import34.NoPreloading;
  _PreloadingStrategy_55:any;
  _RouterPreloader_56:import34.RouterPreloader;
  __PreloadAllModules_57:import34.PreloadAllModules;
  __ROUTER_INITIALIZER_58:any;
  __APP_BOOTSTRAP_LISTENER_59:any[];
  __Configuration_60:import35.Configuration;
  __ThingService_61:import36.ThingService;
  ...
  get _APP_ID_20():any {
    if ((this.__APP_ID_20 == null)) { (this.__APP_ID_20 = import41._appIdRandomProviderFactory()); }
  ...
  get _EventManager_24():import18.EventManager {
    if ((this.__EventManager_24 == null)) { (this.__EventManager_24 = new import18.EventManager(this._EVENT_MANAGER_PLUGINS_23,this.parent.get(import44.NgZone))); }
  ...
  get _NgProbeToken_28():any[] {
    if ((this.__NgProbeToken_28 == null)) { (this.__NgProbeToken_28 = [import5.routerNgProbeToken()]); }
    return this.__NgProbeToken_28;
  }
  get _RootRenderer_29():any {
    if ((this.__RootRenderer_29 == null)) { (this.__RootRenderer_29 = import45._createConditionalRootRenderer(this._DomRootRenderer_27,this.parent.get(import45.NgProbeToken,(null as any)),this._NgProbeToken_28)); }
  ...
  get _AnimationQueue_32():import22.AnimationQueue {
    if ((this.__AnimationQueue_32 == null)) { (this.__AnimationQueue_32 = new import22.AnimationQueue(this.parent.get(import44.NgZone))); }
  ...
  get _LocationStrategy_47():any {
    if ((this.__LocationStrategy_47 == null)) { (this.__LocationStrategy_47 = import5.provideLocationStrategy(this.parent.get(import47.PlatformLocation),this.parent.get(import48.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_46)); }
    return this.__LocationStrategy_47;
  }
  get _Location_48():import30.Location {
    if ((this.__Location_48 == null)) { (this.__Location_48 = new import30.Location(this._LocationStrategy_47)); }
    return this.__Location_48;
  }
  get _UrlSerializer_49():import31.DefaultUrlSerializer {
    if ((this.__UrlSerializer_49 == null)) { (this.__UrlSerializer_49 = new import31.DefaultUrlSerializer()); }
    return this.__UrlSerializer_49;
  }
  get _RouterOutletMap_50():import32.RouterOutletMap {
    if ((this.__RouterOutletMap_50 == null)) { (this.__RouterOutletMap_50 = new import32.RouterOutletMap()); }
    return this.__RouterOutletMap_50;
  }
  get _NgModuleFactoryLoader_51():import33.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_51 == null)) { (this.__NgModuleFactoryLoader_51 = new import33.SystemJsNgModuleLoader(this._Compiler_19,this.parent.get(import33.SystemJsNgModuleLoaderConfig,(null as any)))); }
    return this.__NgModuleFactoryLoader_51;
  }
  get _Router_52():any {
    if ((this.__Router_52 == null)) { (this.__Router_52 = import5.setupRouter(this._ApplicationRef_18,this._UrlSerializer_49,this._RouterOutletMap_50,this._Location_48,this,this._NgModuleFactoryLoader_51,this._Compiler_19,this._ROUTES_45,this._ROUTER_CONFIGURATION_46,this.parent.get(import49.UrlHandlingStrategy,(null as any)),this.parent.get(import50.RouteReuseStrategy,(null as any)))); }
    return this.__Router_52;
  }
  get _ActivatedRoute_53():any {
    if ((this.__ActivatedRoute_53 == null)) { (this.__ActivatedRoute_53 = import5.rootRoute(this._Router_52)); }
    return this.__ActivatedRoute_53;
  }
  get _PreloadAllModules_57():import34.PreloadAllModules {
    if ((this.__PreloadAllModules_57 == null)) { (this.__PreloadAllModules_57 = new import34.PreloadAllModules()); }
    return this.__PreloadAllModules_57;
  }
  get _ROUTER_INITIALIZER_58():any {
    if ((this.__ROUTER_INITIALIZER_58 == null)) { (this.__ROUTER_INITIALIZER_58 = import5.initialRouterNavigation(this._Router_52,this._ApplicationRef_18,this._RouterPreloader_56,this._ROUTER_CONFIGURATION_46)); }
  ...
  get _Configuration_60():import35.Configuration {
    if ((this.__Configuration_60 == null)) { (this.__Configuration_60 = new import35.Configuration()); }
    return this.__Configuration_60;
  }
  get _ThingService_61():import36.ThingService {
    if ((this.__ThingService_61 == null)) { (this.__ThingService_61 = new import36.ThingService(this._Http_44,this._Configuration_60)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__17 = new import15.ApplicationRef_(this.parent.get(import44.NgZone),this.parent.get(import52.Console),this,this._ErrorHandler_14,this,this._ApplicationInitStatus_15,this.parent.get(import14.TestabilityRegistry,(null as any)),this._Testability_16);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import54.DOCUMENT)) { return this._DOCUMENT_21; }
    ...
    if ((token === import55.AnimationDriver)) { return this._AnimationDriver_26; }
    ...
    if ((token === import56.RootRenderer)) { return this._RootRenderer_29; }
    if ((token === import21.DomSanitizer)) { return this._DomSanitizer_30; }
    if ((token === import57.Sanitizer)) { return this._Sanitizer_31; }
    ...
    if ((token === import60.XSRFStrategy)) { return this._XSRFStrategy_41; }
    if ((token === import28.XHRBackend)) { return this._XHRBackend_42; }
    if ((token === import29.RequestOptions)) { return this._RequestOptions_43; }
    if ((token === import61.Http)) { return this._Http_44; }
    if ((token === import62.ROUTES)) { return this._ROUTES_45; }
    if ((token === import5.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_46; }
    if ((token === import48.LocationStrategy)) { return this._LocationStrategy_47; }
    if ((token === import30.Location)) { return this._Location_48; }
    if ((token === import31.UrlSerializer)) { return this._UrlSerializer_49; }
    if ((token === import32.RouterOutletMap)) { return this._RouterOutletMap_50; }
    if ((token === import63.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_51; }
    if ((token === import51.Router)) { return this._Router_52; }
    if ((token === import64.ActivatedRoute)) { return this._ActivatedRoute_53; }
    if ((token === import34.NoPreloading)) { return this._NoPreloading_54; }
    if ((token === import34.PreloadingStrategy)) { return this._PreloadingStrategy_55; }
    if ((token === import34.RouterPreloader)) { return this._RouterPreloader_56; }
    if ((token === import34.PreloadAllModules)) { return this._PreloadAllModules_57; }
    ...
    if ((token === import35.Configuration)) { return this._Configuration_60; }
    if ((token === import36.ThingService)) { return this._ThingService_61; }
